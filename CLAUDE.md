...
> Every AI agent (Claude, Antigravity, Codex, Cursor) **MUST ALWAYS** read and adhere to [`ANTIGRAVITY.md`](file:///C:/Projects/oppverse_ai/ANTIGRAVITY.md) and its 20 Immutable Rules before touching any code or making any modifications in this repository.
...
- **AI agents are restricted strictly to backend logic, API routes, data pipelines, error fixes, and build validations.**
