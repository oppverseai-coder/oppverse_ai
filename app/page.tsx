                ...
                >
                  ...
                  <div className={`p-3.5 rounded-xl border space-y-2 ${
                    isIneligible 
                      ...
                      : 'bg-zinc-900/80 border-zinc-800/90 text-zinc-300'
                  }`}>
                  ...
                  <div className="flex flex-wrap items-center gap-2 text-[11px] text-zinc-400 pt-1">
                    <span className="px-2.5 py-1 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center gap-1">
                      <MapPin className="w-3 h-3 text-zinc-500" />
                      {opp.locationType} {opp.hostCity ? `(${opp.hostCity})` : ''}
                    </span>
                    <span className="px-2.5 py-1 rounded-lg bg-zinc-900 border border-zinc-800 text-cyan-300 font-medium">
